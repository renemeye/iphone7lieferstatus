...
(function() {
  var background_color, border_color, colors, database, devices, load_order_date_selector, model_sorter, model_storage, model_type, models, nicer_date, order_dates, pad, prepare_week_table, print_footer, print_header, process_data, process_with_ticket, process_without_ticket, storages, stringify_model, ticket_dates, types,
  ...
  process_without_ticket = function() {
    return process_data(data_without_ticket.data);
  };
